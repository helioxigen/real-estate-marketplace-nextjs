    ...
    <main className={className}>
      ...
      <div className="page-content">
          ...
          <CallbackForm
            ...
            header={
              <header className="touch-only">
                ...
                <p>
                  Просто оставьте заявку. Наш агент свяжется с вами и поможет
                  всё организовать: проведёт фотосессию, создаст рекламную
                  кампанию, покажет дом и подготовит сделку.
                </p>
              </header>
            }
            fields={{
        ...
        <figure ref={figureRef}>
          {figureInView && <img src="/static/landing/placeholder.jpg" alt="" />}
        </figure>
        {figureInView && <Location className="location" />}
      </div>
    </main>
  );
};
  ...
  ${media.phoneL.to(
    css => css`
      .call-block {
        color: white;
        text-align: center;
        background: url("/static/landing/call.background.jpg") center / cover
          no-repeat;
      }
